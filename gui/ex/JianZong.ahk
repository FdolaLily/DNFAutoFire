...
Gui JianZong:Add, Edit, vJianZongDelay x8 y32 w80 h20 +Number
Gui JianZong:Add, Text, x8 y56 w80 h20 +0x200, 帝国剑术键
Gui JianZong:Add, Edit, vJianZongSkillKey hwndJianZongSkillKeyHwnd x8 y80 w104 h20 +ReadOnly -WantCtrlA
Gui JianZong:Add, Button, gJianZongSave x8 y108 w104 h26, 保存
Gui JianZong:Add, Button, gJianZongHelp x94 y8 w18 h18, ?

RegisterDirectKeyInput("JianZong", "JianZongSkillKey", JianZongSkillKeyHwnd)

ShowGuiJianZong(){
    Gui JianZong:Show, w120 h142, 太宗帝剑延迟
    JianZongLoadConfig()
    DisableGuiMain()
}
